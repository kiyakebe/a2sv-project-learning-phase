...
const AboutJob = ({data}: {data: Opportunity}) => {
  ...
  return (
    <div className="w-3/12 shrink-0 grow ">
      <div className="">
        ...
        <AboutCard
          title="Posted On"
          desc={new Date(data.createdAt).toDateString()}
          icon="/icons/postedate.png"
        />
        <AboutCard
          title="Deadline"
          desc={new Date(data.deadline).toDateString()}
          icon="/icons/deadline.png"
        />
        <AboutCard
          title="Location"
          desc={data.location.join(", ")}
          icon="/icons/location.png"
        />
        <AboutCard
          title="Start Date"
          desc={new Date(data.startDate).toDateString()}
          icon="/icons/date.png"
        />
        <AboutCard
          title="End Date"
          desc={new Date(data.endDate).toDateString()}
          icon="/icons/date.png"
        />
      </div>
